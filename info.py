...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002774556799'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002774556799'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002774556799'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002774556799')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002774556799')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/ROCKERSBACKUP')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channel = environ.get('AUTH_REQ_CHANNEL', '-1001910410959')  # requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002774556799'))  # Notification of sent to your channel
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002774556799')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002774556799')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
...
FQDN = "satisfied-ysabel-projnanesh-ed31f985.koyeb.app"
URL = f"https://{FQDN}/"
